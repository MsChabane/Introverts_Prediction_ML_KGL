...
from ml_introvert.utils.common import reading_data,save_dataframe,save_bin,read_params
import os 
import yaml


if __name__=='__main__':
    params = read_params(key='preprocessing')
    ...
    train_data,test_data = train_test_split(Xresample,test_size=params['test_size'],random_state=params['random_state'])
